<?php
	...
	*/
	...
	/*	
	print_r("\n\n\t"."===========================================================================");
	print_r("\n\t"."DESCRIPTION : Dashboard_azure.php TEST CASE LIST");
	print_r("\n\t"."===========================================================================");
...
class Dashboard_azure_test extends TestCase
{
	...
	/*
	 | Model - Dashboard_azure controller
	...
	/*
    | Controller - Dashboard_azure | Test Case No.- (01).
    ...
    */
	public function test_index(){
		$output = $this->request('GET', ['Dashboard_azure', 'index']);
		if($output != ""){
			$this->assertContains('<title>Cloud Scheduler</title>', $output);
		}
	}
	/*
	 | Controller - Dashboard_azure | Test Case No.- (02).
	...
	public function test_dashchart(){
		...
		$_POST['Year']='2017';
		$output = $this->request('GET', ['Dashboard_azure', 'dashchart'],$array);
		if($output != ""){
