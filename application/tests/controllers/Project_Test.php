<?php
	...
	*/
	...
	/*	
	print_r("\n\n\t"."===========================================================================");
	print_r("\n\t"."DESCRIPTION : Project.php TEST CASE LIST");
	print_r("\n\t"."===========================================================================");
...
class Project_test extends TestCase {
	...
	/*
    | Controller - Project | Test Case No.- (01).
    ...
    */
	...
	/*
    | Controller - Project | Test Case No.- (02).
    | Test Description - This function will check if the view file loaded
    | Assertion - assertResponseCode check the http response code
    */
	...
	/*
    | Controller - Project | Test Case No.- (03).
    | Test Description - This function will check if the view file loaded
    | Assertion - assertResponseCode check the http response code
    */
	...
	/*
    | Controller - Project | Test Case No.- (04).
    | Test Description - This function will check the cron format
    ...
    */
	...
	/*
    | Controller - Project | Test Case No.- (05).
    | Test Description - This function will check the cron format
    | Assertion - assertEquals check the response for a given date time string is in proper cron time format
    */
	...
	/*
    | Controller - Project | Test Case No.- (06).
    | Test Description - 
    | Assertion -
    */
	...
	/*
    | Controller - Project | Test Case No.- (07).
    | Test Description - 
    | Assertion -
    */
	...
	/*
    | Controller - Project | Test Case No.- (08).
    | Test Description - This function will check if the view file loaded
    ...
    */
	...
	/*
    | Controller - Project | Test Case No.- (09).
    | Test Description - This function will check if the view file loaded
    | Assertion - assertEquals checks the reponse based on the post variable projectid 
    */
	...
	/*
    | Controller - Project | Test Case No.- (10).
    ...
    */
	...
	/*
    | Controller - Project | Test Case No.- (11).
    ...
    */
	...
	/*
    | Controller - Project | Test Case No.- (12).
    ...
    */
	...
	/*
    | Controller - Project | Test Case No.- (13).
    | Test Description - This function will edit project projects
    | Assertion - assertResponseCode check the http response code
    */
